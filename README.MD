# 📦 Transaction Service — Django + MongoDB + Celery
...
## 🔁 Rebuilding Transaction Summaries
...
3. **Celery worker:**
   ...
   * For now: just prints a “fake send” log for each medium.
